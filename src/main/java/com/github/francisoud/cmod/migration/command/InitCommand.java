...
//			Files.copy(odchangelogXsd, Paths.get(folder, "odchangelog.xsd"), StandardCopyOption.REPLACE_EXISTING);
			...
			final InputStream initialSchemaXml = getClass().getResourceAsStream("00000000000000_initial_schema.xml");
			Files.copy(initialSchemaXml, Paths.get(folder, "00000000000000_initial_schema.xml"), StandardCopyOption.REPLACE_EXISTING);
		} catch (IOException e) {
